...
<div class="lp-wrap patient-layout">
  ...
  <!-- RIGHT: Brand / pitch / news (rendered second, appears right in patient-layout) -->
  ...
  <div class="lp-form-panel">
    <div class="lp-card">
      ...
      <form action="<?php echo site_url('site/userlogin'); ?>" method="post" class="lp-form">
        <?php echo $this->customlib->getCSRF(); ?>

        <div>
          <label class="lp-label" for="ul-username"><?php echo $this->lang->line('username'); ?></label>
          <input type="text" id="ul-username" name="username" class="lp-input" placeholder="<?php echo $this->lang->line('username'); ?>" autocomplete="username" value="">
          <span class="text-danger"><?php echo form_error('username'); ?></span>
        </div>

        <div>
          <label class="lp-label" for="ul-password"><?php echo $this->lang->line('password'); ?></label>
          <input type="password" id="ul-password" name="password" class="lp-input" placeholder="••••••••" autocomplete="current-password" value="">
        ...
        <div>
          <div class="lp-captcha-row">
            ...
            <div class="lp-captcha-field">
              <label class="lp-label" for="ul-captcha"><?php echo $this->lang->line('enter_captcha'); ?></label>
              <input type="text" id="ul-captcha" name="captcha" class="lp-input" placeholder="<?php echo $this->lang->line('enter_captcha'); ?>" autocomplete="off">
            </div>
          </div>
        ...
        <div class="lp-meta">
          <a href="<?php echo site_url('site/ufpassword'); ?>" class="lp-forgot"><?php echo $this->lang->line('forgot_password'); ?></a>
        </div>

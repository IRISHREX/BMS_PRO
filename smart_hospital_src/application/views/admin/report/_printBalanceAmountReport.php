        ...
        <table class="bal-table">
            ...
            <tfoot class="sh-print-tfoot-spacer">
                <tr class="sh-print-tfoot-spacer-row">
                    <td colspan="12" style="height: 32px !important; border: none !important; padding: 0 !important; margin: 0 !important; background: transparent !important; line-height: 0 !important; font-size: 0 !important;">&nbsp;</td>
                </tr>
            </tfoot>
        </table>
    <?php } else { ?>

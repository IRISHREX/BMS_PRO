...
<style>
    ...
    *, *:before, *:after {
    ...
    .bal-table .col-date      { width: 8.5% !important; }
    .bal-table .col-patient   { width: 12.0% !important; }
    .bal-table .col-staff     { width: 10.5% !important; }
    .bal-table .col-doctor    { width: 10.0% !important; }
    .bal-table .col-amt       { width: 7.0% !important; text-align: right !important; }
    .bal-table .col-discount  { width: 6.5% !important; text-align: right !important; }
    .bal-table .col-tax       { width: 6.0% !important; text-align: right !important; }
    .bal-table .col-net       { width: 7.0% !important; text-align: right !important; }
    .bal-table .col-paid      { width: 6.5% !important; text-align: right !important; }
    .bal-table .col-refund    { width: 6.0% !important; text-align: right !important; }
        ...
        <table class="bal-table">
            ...
            <tbody>
                ...
                <tr class="summary-row">
                    ...
                    <td class="summary-val"><?php echo number_format(abs($total_balance_amount), 2); ?></td>
                </tr>
            </tbody>
            <tfoot class="sh-print-tfoot-spacer">
                <tr class="sh-print-tfoot-spacer-row">
                    <td colspan="13" style="height: 32px !important; border: none !important; padding: 0 !important; margin: 0 !important; background: transparent !important; line-height: 0 !important; font-size: 0 !important;">&nbsp;</td>
                </tr>
            </tfoot>
        </table>
    <?php } else { ?>

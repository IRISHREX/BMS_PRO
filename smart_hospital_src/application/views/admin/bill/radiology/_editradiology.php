...
<div class="sh-form-card mb-3">
    ...
    <div class="p-2">
        <div>
            <table class="table table-sm table-striped table-bordered table-hover tblProducts sh-tbl-fixed sh-radio-edit-table mb-0" id="tableID">
                <thead>
                    <tr>
                    ...
                    <div class="col-sm-4">
                        <div class="mb-3">
                            ...
                            <select name='referral_person_id' id="referral_person_id" class="form-control select2">
                                <option value=""><?php echo $this->lang->line('select'); ?></option>
                                <?php if (!empty($referral_person_list)) { foreach ($referral_person_list as $dkey => $dvalue) { ?>
                                    <option value="<?php echo $dvalue->person_id; ?>" <?php if (isset($radiology_data->referral_person_id) && $dvalue->person_id == $radiology_data->referral_person_id) { echo "selected"; } ?>><?php echo $dvalue->name . " (" . $dvalue->category_name . ")"; ?></option>
                                <?php } } ?>
                            </select>

...
<div class="d-flex gap-2 mb-2 flex-wrap">
    ...
    <div class="sh-tx-col">
        <div class="sh-form-card h-100">
            ...
            <div class="px-3 py-3">
                <form id="<?php echo $form_id; ?>" action="<?php echo site_url($is_refund_mode ? 'admin/radio/partial_refund' : ($is_bill ? 'admin/bill/partial_radiology_bill' : 'admin/radio/partialbill')); ?>" accept-charset="utf-8" method="post">
...
function radioToggleRefundStatus(sel, formId, maxRefund, dueAmount) {
    ...
    form.attr('action', isRefund
        ...
        : '<?php echo site_url($is_bill ? 'admin/bill/partial_radiology_bill' : 'admin/radio/partialbill'); ?>'
    );

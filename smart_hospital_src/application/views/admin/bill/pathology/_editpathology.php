                        ...
                        <div class="mb-3">
                            ...
                            <select name='referral_person_id' id="referral_person_id" class="form-control select2">
                                ...
                                <?php if (!empty($referral_person_list)) { foreach ($referral_person_list as $dkey => $dvalue) { ?>
                                    <option value="<?php echo $dvalue->person_id; ?>" <?php if(isset($pathology_data->referral_person_id) && $pathology_data->referral_person_id == $dvalue->person_id) { echo "selected"; } ?>><?php echo $dvalue->name . " (" . $dvalue->category_name . ")"; ?></option>
                                <?php } } ?>
                            </select>

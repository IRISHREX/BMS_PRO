                        ...
                        <div class="container-fluid">
                            <div class="row">
                                ...
                                <div class="col-lg-7 col-md-5 col-sm-4 text-end">
                                    <label><?php echo $this->lang->line('date'); ?> <input name="date" id="txtDate10" type="text" value="<?php echo date($this->customlib->getHospitalDateFormat(true, true)); ?>" class="transparentbg-border atm-readonly-input datetime no-past-date" data-min-date="today"></label>
                                </div>
                            </div>
                        </div>
                    </div>

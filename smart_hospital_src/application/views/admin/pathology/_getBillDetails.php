    ...
    <tbody>
        <tr><td>
            ...
            <div class="print-area">
                ...
                <div class="sh-print-title"><?php echo $this->lang->line('pathology_single_billing'); ?></div>
                    ...
                    <div class="sh-flex-gap18">
                        ...
                        <table class="sh-print-info-table w-50" >
                            ...
                            <tr>
                                ...
                                <td><?php echo ($result->date ? $this->customlib->YYYYMMDDHisTodateFormat($result->date) : '-'); ?></td>
                            </tr>
                            <tr>

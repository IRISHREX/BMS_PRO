                        ...
                        <div class="container-fluid">
                            <div class="row">
                                ...
                                <div class="col-lg-7 col-md-5 col-sm-4 text-end">
                                    <label class="d-flex align-items-center justify-content-end gap-1 mb-0 text-nowrap datetime"><?php echo $this->lang->line('date'); ?> <input name="date" type="text" id="txtDate10" value="<?php echo date($this->customlib->getHospitalDateFormat(true, true)); ?>" class="transparentbg-border atm-readonly-input datetime no-past-date" data-min-date="today"></label>
                                </div>
                            </div>
                        </div>
                    </div>            

                ...
                <div class="content-body sh-px-12" >
                    <div class="print-area no-global-print-footer">
                        ...
                        <div class="sh-print-info-block">
                            <table class="sh-print-info-table">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <?php echo ($result->prescribe_by_name ? $result->prescribe_by_name . ' ' . $result->prescribe_by_surname . ' (' . $result->prescribe_by_employee_id . ')' : '-'); ?>
                                    </td>
                                    <th><?php echo $this->lang->line('generated_by'); ?></th>
                                    <td>
                                        <?php echo ($result->generated_by_name ? $result->generated_by_name . ' ' . $result->generated_by_surname . ' (' . $result->generated_by_employee_id . ')' : '-'); ?>
                                    </td>
                                    <th ><?php echo $this->lang->line('consultant_doctor'); ?></th>
                                    <td >
                                        <?php echo ($result->name ? $result->name . ' ' . $result->surname . ' (' . $result->doctor_id . ')' : '-'); ?>
                                    </td>
                                </tr> 

                                <tr>
                                    <th ><?php echo $this->lang->line('known_allergies'); ?></th>
                                    <td colspan="5"><?php echo ($result->any_allergies ?: '-'); ?></td>
                                </tr>
                                        ...
                                        foreach ($result->medicines as $pvalue) {
                                            $medsl++; ?>
                                                <tr>
                                                    ...
                                                    <td class="fw-semibold"><?php echo $pvalue->medicine_name; ?></td>
                        ...
                        <?php if (!empty($result->footer_note)) { ?>
                                <div
                                    class="sh-text-11-pad sh-border-top-light">

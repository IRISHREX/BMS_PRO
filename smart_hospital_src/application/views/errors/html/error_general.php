...
<head>
    ...
    <style>
        ...
        * { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .message { font-size: 15px; color: #636e72; line-height: 1.6; margin-bottom: 32px; word-wrap: break-word; text-align: left; background: #f9f9f9; padding: 15px; border-radius: 8px; border: 1px solid #eee; }
        ...
        .btn-primary:hover {
            background: #74b9ff; transform: translateY(-2px);

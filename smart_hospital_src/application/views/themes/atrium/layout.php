...
<link rel="stylesheet" href="<?php echo $base_assets_url; ?>front/css/styles.css?v=<?php echo filemtime(FCPATH.'backend/themes/atrium/front/css/styles.css'); ?>" />
<link rel="stylesheet" href="<?php echo $base_assets_url; ?>front/css/pages.css?v=<?php echo filemtime(FCPATH.'backend/themes/atrium/front/css/pages.css'); ?>" />
